...
the folder where the Motioncor2 is installed. Depending on your CUDA version this plugin will guess the right default binary from ``MotionCor2_1.5.0_CudaXY_05-31-2022``
(X is for cuda major version, Y for the minor). You can always set a different one by explicitly setting *MOTIONCOR2_BIN* variable. If you need to use CUDA different from the one used during Scipion installation
...
For an automatically updated installationof motioncor2 binaries, do not define any of *MOTIONCOR2_HOME* or *MOTIONCOR2_BIN*
