...
class Plugin(pwem.Plugin):
    ...
    _supportedVersions = ['1.0.2', '1.0.5', '1.1.0', '1.2.1', '1.2.3']

    @classmethod
    def _defineVariables(cls):
        cls._defineEmVar(MOTIONCOR2_HOME, 'motioncor2-1.2.3')
        cls._defineVar(MOTIONCOR2_BIN, 'MotionCor2_1.2.3-Cuda80')
