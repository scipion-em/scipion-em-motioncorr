...
from motioncorr import __version__
...
setup(
    ...
    description='Plugin to use motioncor programs within the Scipion framework',  # Required
    ...
    install_requires=['scipion-em', 'emtable', 'emtools',
                      'scipion-em-relion', 'tifffile'],  # Optional
